...
public class TabelaHash {
    ...
    // encontro as maiores listas encadeadas
    ...
    public int[] gaps() {
        ...
        // trato o gap final se a tabela terminar com nulls
        if (atualGap > 0) {
            if (atualGap < menor) menor = atualGap;
            if (atualGap > maior) maior = atualGap;
            soma += atualGap;
